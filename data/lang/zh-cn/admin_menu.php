<?php
return array (
  'ADMIN_APPOINTMENT_ABOUT' => '关于云礼堂',
  'ADMIN_APPOINTMENT_APPOINTMENT' => '--new--',
  'ADMIN_APPOINTMENT_APPOINTMENT_ADD' => '添加预约',
  'ADMIN_APPOINTMENT_APPOINTMENT_DELETE' => '删除预约',
  'ADMIN_APPOINTMENT_APPOINTMENT_EDIT' => '编辑预约',
  'ADMIN_APPOINTMENT_APPOINTMENT_VERIFY' => '预约审核',
  'ADMIN_APPOINTMENT_DEFAULT' => '预约管理',
  'ADMIN_APPOINTMENT_INDEX' => '预约列表',
  'ADMIN_APPOINTMENT_SETTING' => '--new--',
  'ADMIN_ARTICLE_CAMERA' => '随手拍管理',
  'ADMIN_ARTICLE_CAMERA_ADD' => '添加随手拍',
  'ADMIN_ARTICLE_CAMERA_DELETE' => '删除随手拍',
  'ADMIN_ARTICLE_DEFAULT' => '图文管理',
  'ADMIN_ARTICLE_GROUP' => '机构团体管理',
  'ADMIN_ARTICLE_GROUP_ADD' => '添加社会文化机构团体',
  'ADMIN_ARTICLE_GROUP_DELETE' => '删除社会文化机构团体',
  'ADMIN_ARTICLE_GROUP_EDIT' => '编辑社会文化机构团体',
  'ADMIN_ARTICLE_HALL' => '礼堂管理',
  'ADMIN_ARTICLE_HALL_ADD' => '添加公礼堂',
  'ADMIN_ARTICLE_HALL_DELETE' => '删除礼堂',
  'ADMIN_ARTICLE_HALL_EDIT' => '编辑礼堂',
  'ADMIN_ARTICLE_INFORMATION' => '资讯管理',
  'ADMIN_ARTICLE_INFORMATION_ADD' => '添加资讯',
  'ADMIN_ARTICLE_INFORMATION_DELETE' => '删除资讯',
  'ADMIN_ARTICLE_INFORMATION_EDIT' => '编辑资讯',
  'ADMIN_ARTICLE_VOLUNTEER' => '志愿者管理',
  'ADMIN_ARTICLE_VOLUNTEER_ADD' => '添加志愿者',
  'ADMIN_ARTICLE_VOLUNTEER_DELETE' => '删除机构团体',
  'ADMIN_ARTICLE_VOLUNTEER_EDIT' => '编辑志愿者',
  'ADMIN_CONFIG_ADD' => '添加配置',
  'ADMIN_CONFIG_DELETE' => '删除配置',
  'ADMIN_CONFIG_DISTRIBUTION' => '分销设置',
  'ADMIN_CONFIG_EDIT' => '编辑配置',
  'ADMIN_CONFIG_INDEX' => '配置管理',
  'ADMIN_CONFIG_READ' => '设置配置',
  'ADMIN_CONFIG_SAVE' => '保存配置',
  'ADMIN_CONFIG_SORT' => '排序配置',
  'ADMIN_CONFIG_TOGGLE' => '隐藏配置',
  'ADMIN_CONTENT_ACCOUNT' => '账单管理',
  'ADMIN_CONTENT_ANSWER' => '回答列表',
  'ADMIN_CONTENT_CAMERA' => '随手拍管理',
  'ADMIN_CONTENT_CAMERA_ADD' => '添加随手拍',
  'ADMIN_CONTENT_CAMERA_DELETE' => '删除随手拍',
  'ADMIN_CONTENT_DEFAULT' => '内容管理',
  'ADMIN_CONTENT_EXPORT' => '导出统计数据',
  'ADMIN_CONTENT_GUESTBOOK' => '用户留言',
  'ADMIN_CONTENT_HALL' => '礼堂管理',
  'ADMIN_CONTENT_HALL_ADD' => '添加公礼堂',
  'ADMIN_CONTENT_HALL_DELETE' => '删除公告',
  'ADMIN_CONTENT_HALL_EDIT' => '编辑礼堂',
  'ADMIN_CONTENT_INFORMATION' => '资讯管理',
  'ADMIN_CONTENT_INFORMATION_ADD' => '添加资讯',
  'ADMIN_CONTENT_INFORMATION_DELETE' => '删除公告',
  'ADMIN_CONTENT_INFORMATION_EDIT' => '编辑资讯',
  'ADMIN_CONTENT_NOTICE' => '--new--',
  'ADMIN_CONTENT_NOTICE_ADD' => '添加公告',
  'ADMIN_CONTENT_NOTICE_DELETE' => '删除公告',
  'ADMIN_CONTENT_NOTICE_EDIT' => '编辑公告',
  'ADMIN_CONTENT_PUSH' => '推送',
  'ADMIN_CONTENT_QUESTION' => '咨询列表',
  'ADMIN_CONTENT_RECHARGE' => '充值',
  'ADMIN_CONTENT_REFUND' => '退款管理',
  'ADMIN_CONTENT_REFUNDCHECK' => '退款审核',
  'ADMIN_CONTENT_RELATIONSHIP' => '用户关系',
  'ADMIN_CONTENT_USERCHECK' => '用户审核',
  'ADMIN_CONTENT_USERINFO' => '用户信息',
  'ADMIN_CONTENT_USERLIST' => '用户列表',
  'ADMIN_CONTENT_WITHDRAW' => '提现管理',
  'ADMIN_CONTENT_WITHDRAWCHECK' => '提现审核',
  'ADMIN_DEPARTMENT_ADD' => '添加科室领域',
  'ADMIN_DEPARTMENT_DELETE' => '删除科室领域',
  'ADMIN_DEPARTMENT_EDIT' => '编辑科室领域',
  'ADMIN_DEPARTMENT_INDEX' => '科室领域',
  'ADMIN_DEPARTMENT_SORT' => '科室领域排序',
  'ADMIN_DEPARTMENT_TOGGLE' => '科室领域显示隐藏',
  'ADMIN_GXZH_ACCOUNT' => '账单管理',
  'ADMIN_GXZH_ANSWER' => '回答列表',
  'ADMIN_GXZH_DEFAULT' => '共享智慧',
  'ADMIN_GXZH_EXPORT' => '导出统计数据',
  'ADMIN_GXZH_GUESTBOOK' => '用户留言',
  'ADMIN_GXZH_NOTICE' => '系统公告',
  'ADMIN_GXZH_NOTICE_ADD' => '添加公告',
  'ADMIN_GXZH_NOTICE_DELETE' => '删除公告',
  'ADMIN_GXZH_NOTICE_EDIT' => '编辑公告',
  'ADMIN_GXZH_PUSH' => '推送',
  'ADMIN_GXZH_QUESTION' => '咨询列表',
  'ADMIN_GXZH_RECHARGE' => '充值',
  'ADMIN_GXZH_REFUND' => '退款管理',
  'ADMIN_GXZH_REFUNDCHECK' => '退款审核',
  'ADMIN_GXZH_RELATIONSHIP' => '用户关系',
  'ADMIN_GXZH_USERCHECK' => '用户审核',
  'ADMIN_GXZH_USERINFO' => '用户信息',
  'ADMIN_GXZH_USERLIST' => '用户列表',
  'ADMIN_GXZH_WITHDRAW' => '提现管理',
  'ADMIN_GXZH_WITHDRAWCHECK' => '提现审核',
